...
public class LocationFilter extends HttpFilter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        if(employee != null && (employee.getRoles().contains(Role.Administrator) || employee.getRoles().contains(Role.RentalManager))) {
