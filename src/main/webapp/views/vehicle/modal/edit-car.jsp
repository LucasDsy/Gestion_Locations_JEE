...
%>
<div class="modal fade bd-example-modal-lg" id="editCar<%= id %>" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col">
                        <label for="<%= SEATING_CAPACITY %><%= id %>">Nombre de places</label>
                        <input type="number" min="0" max="9" class="form-control" value="<%= seatingCapacity %>" id="<%= SEATING_CAPACITY %><%= id %>" name="<%= SEATING_CAPACITY %>" required>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="editCar(<%= id %>)">Modifier</button>
            </div>
        </div>
    </div>
</div>